...
===================
Sample android app for medium. It showcases process of generating android retrofit2 api-client library from OpenAPI specification and how to use the `ApiClient` and retrofit.
