...
import info.hossainkhan.mediumsample.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(PublicationDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(PublicationDetailFragment.ARG_ITEM_ID, holder.mItem.id);
